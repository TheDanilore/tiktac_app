...
void _showTimePicker(BuildContext context, TimerCubit cubit) {
  Duration tempDuration = Duration(
    seconds: cubit.state.initialSeconds > 0 ? cubit.state.initialSeconds : 0,
  );
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        double maxCircleSize = constraints.maxWidth > 500
            ? 400.0
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  if (state is! TimerInitial) const SizedBox(width: 64),
