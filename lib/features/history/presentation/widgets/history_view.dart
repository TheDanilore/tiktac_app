...
class _HistoryViewState extends State<HistoryView> {
            ...
            child: Column(
              ...
              children: [
                ...
                ListTile(
                  ...
                  subtitle: const Text('Ideal para importar de vuelta a la app o abrir en Excel.'),
                ...
                ListTile(
                  ...
                  subtitle: const Text('Formato simple de lectura sin formato.'),
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
                  tileColor: Theme.of(context).colorScheme.surfaceContainerHighest,
  ...
  void _showMoreOptions(BuildContext context, StopwatchCubit cubit, bool hasEntries) {
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                title: Text('Borrar todo el historial', style: TextStyle(color: theme.colorScheme.error)),
                enabled: hasEntries,
                onTap: () {
                  Navigator.pop(context);
                  showDialog(
                    ...
                    builder: (dialogContext) => AlertDialog(
                      ...
                      content: const Text('¿Estás seguro de que quieres eliminar permanentemente todo el historial?'),
                      actions: [
                        TextButton(
          ...
          slivers: [
            ...
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: Row(
                  children: [
                    Text('Historial', style: theme.textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.bold)),
                    const Spacer(),
                    IconButton(
                      icon: const Icon(Icons.more_vert),
                      onPressed: () => _showMoreOptions(context, cubit, hasEntries),
              ...
              SliverPadding(
                ...
                sliver: SliverList(
                  delegate: SliverChildBuilderDelegate(
                    (context, index) => HistoryCard(entry: displayList[index]),
